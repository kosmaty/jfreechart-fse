...
public class XYItemRendererState extends RendererState {
	...
	public XYItemRendererState(PlotRenderingInfo info) {
		super(info);
		this.workingLine = emptyLine();
		this.processVisibleItemsOnly = true;
	}

	/**
	 * Returns the flag that controls whether the plot passes all data items in
	 * each series to the renderer, or just the visible items. The default value
	 * is <code>true</code>.
	 *
	 * @return A boolean.
	 *
	...
	/**
	 * Sets the flag that controls whether the plot passes all data items in
	 * each series to the renderer, or just the visible items.
	 *
	 * @param flag
	 *            the new flag value.
	 *
	...
	/**
	 * This method is called by the {@link XYPlot} when it starts a pass through
	 * the (visible) items in a series. The default implementation records the
	 * first and last item indices - override this method to implement
	 * additional specialised behaviour.
	 *
	 * @param dataset
	 *            the dataset.
	 * @param series
	 *            the series index.
	 * @param firstItem
	 *            the index of the first item in the series.
	 * @param lastItem
	 *            the index of the last item in the series.
	 * @param pass
	 *            the pass index.
	 * @param passCount
	...
	/**
	 * This method is called by the {@link XYPlot} when it ends a pass through
	 * the (visible) items in a series. The default implementation does nothing,
	 * but you can override this method to implement specialised behaviour.
	 *
	 * @param dataset
	 *            the dataset.
	 * @param series
