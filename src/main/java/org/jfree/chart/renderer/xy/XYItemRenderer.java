...
public interface XYItemRenderer extends Renderer {
	 ...
	 * specified dataset. The implementation of this method will take into
	 * account the presentation used by the renderers (for example, a renderer
	 * that "stacks" values will return a bigger range than a renderer that
	 * doesn't).
	 *
	 * @param dataset
	 *            the dataset (<code>null</code> permitted).
	 ...
	 *            the end value.
	 */
	public void fillDomainGridBand(GraphicsContext g2,
			XYPlot plot,
			ValueAxis axis,
			Rectangle2D dataArea,
	 ...
	 *            the end value.
	 */
	public void fillRangeGridBand(GraphicsContext g2,
			XYPlot plot,
			ValueAxis axis,
			Rectangle2D dataArea,
			double start, double end);
	 ...
	 *            the value.
	 */
	public void drawDomainGridline(GraphicsContext g2,
			XYPlot plot,
			ValueAxis axis,
			Rectangle2D dataArea,
			double value);
	 ...
	 *            the axis data area.
	 */
	public void drawDomainMarker(GraphicsContext g2, XYPlot plot, ValueAxis axis,
	 ...
	 *            the axis data area.
	 */
	public void drawRangeMarker(GraphicsContext g2, XYPlot plot, ValueAxis axis,
			Marker marker, Rectangle2D dataArea);
