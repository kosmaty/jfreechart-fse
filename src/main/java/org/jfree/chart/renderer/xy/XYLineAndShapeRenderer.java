 ...
 * {@code XYLineAndShapeRendererDemo2.java} program included in the JFreeChart
 * demo collection: <br>
 * <br>
...
public class XYLineAndShapeRenderer extends AbstractXYItemRenderer
	 ...
	 * {@code getSeriesShapesVisible} method. You can override this method if
	 ...
	 * <p>
	 * The default implementation passes control to the
	 * {@code getSeriesShapesFilled} method. You can override this method if you
	...
	/**
	 * Returns {@code true} if the renderer should use the fill paint setting to
	 * fill shapes, and {@code false} if it should just use the regular paint.
	 * <p>
	 * Refer to {@code XYLineAndShapeRendererDemo2.java} to see the effect of
	 * this flag.
	 *
	 * @return A boolean.
	 *
	...
	/**
	 * Returns {@code true} if the renderer should use the outline paint setting
	 * to draw shape outlines, and {@code false} if it should just use the
	 * regular paint.
	 *
	 * @return A boolean.
	 *
	 ...
	 */
	@Override
	public XYItemRendererState initialise(GraphicsContext g2,
	...
	protected void drawPrimaryLine(XYItemRendererState state,
		...
		if (orientation == PlotOrientation.HORIZONTAL) {
			state.workingLine = newLine(transY0, transX0, transY1, transX1);
		}
	...
	protected void drawPrimaryLineAsPath(XYItemRendererState state,
			GraphicsContext g2, XYPlot plot,
			XYDataset dataset,
			int pass,
			int series,
			int item,
	 ...
	 * draws the shapes which mark the item positions. If {@code entities} is
	 * not {@code null} it will be populated with entity information for points
	 ...
	 */
	protected void drawSecondaryPass(GraphicsContext g2, XYPlot plot,
			XYDataset dataset,
