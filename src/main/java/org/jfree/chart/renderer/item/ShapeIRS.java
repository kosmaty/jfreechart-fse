 ...
 * Works however only if the descendant of {@link AbstractRenderer} uses the per
 * item method {@link AbstractRenderer#getItemShape(int, int)} <br>
 * <br>
 * Important Shape is not serializable see {@link IRSUtilities}) for the correct
 * implementation of the custom read and write method.
 * 
 * @author zinsmaie
 */
