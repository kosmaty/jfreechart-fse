...
public interface Renderer extends LegendItemSource {
	...
	// * @see #getSeriesVisible(int)
	// */
	// public void setSeriesVisible(int series, Boolean visible, boolean
	// notify);
	//
	// /**
	...
	//
	// /**
	// * Sets the default visibility and sends a {@link RendererChangeEvent} to
	// all
	...
	// /**
	// * Sets the flag that controls whether a series is visible in the legend
	// * and, if requested, sends a {@link RendererChangeEvent} to all
	// registered
	// * listeners.
	// *
	// * @param series the series index.
	...
	// * @see #getDefaultSeriesVisibleInLegend()
	// */
	// public void setDefaultSeriesVisibleInLegend(boolean visible, boolean
	// notify);
	//
	//
	// //// PAINT
	...
	//
	// public void setSeriesOutlineStroke(int series, Stroke stroke, boolean
	// notify);
	//
	// /**
	...
	// */
	// public ItemLabelPosition getPositiveItemLabelPosition(int row, int
	// column);
	//
	// /**
	...
	// * @return The item label position.
	// */
	// public ItemLabelPosition getNegativeItemLabelPosition(int row, int
	// column);
	//
	// /**
	...
	//
	// /**
	// * Sets the item label position for negative values in a series and sends
	// a
	// * {@link RendererChangeEvent} to all registered listeners.
	// *
	// * @param series the series index (zero-based).
	...
	// */
	// public void setDefaultNegativeItemLabelPosition(ItemLabelPosition
	// position);
	//
	// /**
	// * Sets the default negative item label position and, if requested, sends
	// a
	// * {@link RendererChangeEvent} to all registered listeners.
	// *
	// * @param position the position.
