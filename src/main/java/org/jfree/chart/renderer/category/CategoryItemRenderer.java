...
public interface CategoryItemRenderer extends Renderer {
	 ...
	 * outlined in the general description of this interface.
	 *
	 * @param row
	 ...
	 *
	 * @param generator
	 *            the item URL generator (<code>null</code> permitted).
	 *
	 ...
	 *            the pass index.
	 */
	public void drawItem(GraphicsContext g2, CategoryItemRendererState state,
	 ...
	 *            the value.
	 *
	 * @see #drawRangeGridline(GraphicsContext, CategoryPlot, ValueAxis,
	 *      Rectangle2D, double)
	 */
	 ...
	 *            the value.
	 *
	 * @see #drawDomainGridline(GraphicsContext, CategoryPlot, Rectangle2D,
	 *      double)
	 */
	 ...
	 *
	 * @see #drawRangeMarker(GraphicsContext, CategoryPlot, ValueAxis, Marker,
	 *      Rectangle2D)
	 */
	 ...
	 *            the area for plotting data (not including 3D effect).
	 *
	 * @see #drawDomainMarker(GraphicsContext, CategoryPlot, CategoryAxis,
