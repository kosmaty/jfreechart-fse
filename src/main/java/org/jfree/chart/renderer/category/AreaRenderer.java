 ...
 * with the {@link CategoryPlot} class. The example shown here is generated by
 * the <code>AreaChartDemo1.java</code> program included in the JFreeChart Demo
 * Collection: <br>
 * <br>
...
public class AreaRenderer extends AbstractCategoryItemRenderer
	...
	/**
	 * Returns a token that controls how the renderer draws the end points. The
	 * default value is {@link AreaRendererEndType#TAPER}.
	 *
