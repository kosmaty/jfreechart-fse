...
public abstract class AbstractRenderer implements Cloneable, Serializable {
	 ...
	 * renderer uses {@link #getItemVisible(int, int)} ... )
	 */
	 ...
	 * <code>isSeriesVisible(series)</code> method. You can implement your own
	 * {@link VisibilityIRS} or override this method if you require different
	 * behavior.
	 *
	 * @param series
	 *            the series index.
	...
	protected Point2D calculateLabelAnchorPoint(ItemLabelAnchor anchor,
		...
		if (anchor == ItemLabelAnchor.CENTER) {
			...
			result = new Point2D(x + OPP * this.itemLabelAnchorOffset,
					y - ADJ * this.itemLabelAnchorOffset);
		}
		else if (anchor == ItemLabelAnchor.INSIDE2) {
			result = new Point2D(x + ADJ * this.itemLabelAnchorOffset,
					y - OPP * this.itemLabelAnchorOffset);
		}
		else if (anchor == ItemLabelAnchor.INSIDE3) {
			result = new Point2D(x + this.itemLabelAnchorOffset, y);
		}
			...
			result = new Point2D(x, y + this.itemLabelAnchorOffset);
		}
			...
			result = new Point2D(x + 2.0 * this.itemLabelAnchorOffset,
					y);
		}
