...
public abstract class ChartFactory {
	...
	// * <P>
	// * The chart object returned by this method uses a {@link PiePlot}
	// instance
	// * as the plot.
	// *
	...
	// * @param percentDiffForMaxScale scale goes from bright red/green to
	// black,
	...
	// * @since 1.0.7
	// */
	// public static JFreeChart createRingChart(String title, PieDataset
	// dataset,
	// Locale locale) {
	//
	...
	// * @since 1.0.7
	// */
	// public static JFreeChart createPieChart3D(String title, PieDataset
	// dataset,
	// Locale locale) {
	//
	 ...
	 *            the label for the category axis ({@code null} permitted).
	 * @param valueAxisLabel
	 *            the label for the value axis ({@code null} permitted).
	 * @param dataset
	...
	// * @return A chart.
	// */
	// public static JFreeChart createPolarChart(String title, XYDataset
	// dataset) {
	...
	// */
	// public static JFreeChart createScatterPlot(String title, String
	// xAxisLabel,
	...
	// * <P>
	// * The chart object returned by this method uses an {@link XYPlot}
	// instance
	// * as the plot, with a {@link DateAxis} for the domain axis, a
	// * {@link NumberAxis} as the range axis, and a {@link XYBarRenderer} as
	// the
	// * renderer.
	// *
	// * @param title the chart title ({@code null} permitted).
	...
	// */
	// public static JFreeChart createXYBarChart(String title, String
	// xAxisLabel,
	...
	// */
	// public static JFreeChart createXYAreaChart(String title,String
	// xAxisLabel,
	// String yAxisLabel, XYDataset dataset) {
	//
	// NumberAxis xAxis = new NumberAxis(xAxisLabel);
	...
	// * @return A chart.
	// */
	// public static JFreeChart createXYStepChart(String title, String
	// xAxisLabel,
	// String yAxisLabel, XYDataset dataset) {
	//
	...
	// * a {@link NumberAxis} for the range axis, and an {@link
	// XYBubbleRenderer}
	...
	// */
	// public static JFreeChart createBubbleChart(String title, String
	// xAxisLabel,
