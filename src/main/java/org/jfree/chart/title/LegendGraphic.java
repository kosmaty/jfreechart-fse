...
public class LegendGraphic extends AbstractBlock implements Block,
	...
	protected Size2D arrangeNN(GraphicsContext g2) {
		Rectangle2D contentSize = Rectangle2D.EMPTY;
		if (this.line != null) {
			contentSize = asRectangle2D(this.line.getBounds());
		}
		if (this.shape != null) {
			contentSize = union(contentSize, asRectangle2D(this.shape.getBounds()));
		}
