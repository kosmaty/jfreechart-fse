...
public class FlowArrangement implements Arrangement, Serializable {
	 ...
	 * <code>GraphicsContext</code> can be used by some items (particularly
	 * items containing text) to calculate sizing parameters.
	 *
	 * @param container
	...
	protected Size2D arrangeFN(BlockContainer container, GraphicsContext g2,
		...
		for (Block block : blocks) {
			...
			if (x + size.width <= width) {
				...
				block.setBounds(
						new Rectangle2D(x, y, size.width, size.height)
						);
	 ...
	 */
	protected Size2D arrangeRR(BlockContainer container, GraphicsContext g2,
			RectangleConstraint constraint) {
	 ...
	 * @return The size following the arrangement.
	 */
	protected Size2D arrangeRF(BlockContainer container, GraphicsContext g2,
			RectangleConstraint constraint) {
	 ...
	 * @return The size following the arrangement.
	 */
	protected Size2D arrangeRN(BlockContainer container, GraphicsContext g2,
			RectangleConstraint constraint) {
	 ...
	 * @return The size after the arrangement.
	 */
	protected Size2D arrangeNF(BlockContainer container, GraphicsContext g2,
			RectangleConstraint constraint) {
