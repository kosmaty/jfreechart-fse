...
public class AbstractBlock implements Cloneable, Serializable {
	 ...
	 */
	public Size2D arrange(GraphicsContext g2) {
	 ...
	 *            the area.
	 */
	protected void drawBorder(GraphicsContext g2, Rectangle2D area) {
	...
	public Object clone() throws CloneNotSupportedException {
		...
		// no need to clone bounds - it is immutable in javafx
