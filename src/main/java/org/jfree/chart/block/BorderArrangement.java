...
public class BorderArrangement implements Arrangement, Serializable {
	 ...
	 */
	@Override
	public Size2D arrange(BlockContainer container, GraphicsContext g2,
	 ...
	 */
	protected Size2D arrangeNN(BlockContainer container, GraphicsContext g2) {
		...
		if (this.topBlock != null) {
			this.topBlock.setBounds(new Rectangle2D(0.0, 0.0, width,
					h[0]));
		}
		if (this.bottomBlock != null) {
			this.bottomBlock.setBounds(new Rectangle2D(0.0,
					height - h[1], width, h[1]));
		}
		if (this.leftBlock != null) {
			this.leftBlock.setBounds(new Rectangle2D(0.0, h[0], w[2],
					centerHeight));
		}
		if (this.rightBlock != null) {
			this.rightBlock.setBounds(new Rectangle2D(width - w[3],
					h[0], w[3], centerHeight));
		}

		if (this.centerBlock != null) {
			this.centerBlock.setBounds(new Rectangle2D(w[2], h[0],
	 ...
	 * @return The container size after the arrangement.
	 */
	protected Size2D arrangeFR(BlockContainer container, GraphicsContext g2,
			RectangleConstraint constraint) {
	 ...
	 */
	protected Size2D arrangeFN(BlockContainer container, GraphicsContext g2,
			double width) {
		double[] w = new double[5];
		double[] h = new double[5];
	...
	protected Size2D arrangeRR(BlockContainer container, Range widthRange,
			Range heightRange, GraphicsContext g2) {
		double[] w = new double[5];
		double[] h = new double[5];
		if (this.topBlock != null) {
	 ...
	 * @return The container size after the arrangement.
	 */
	protected Size2D arrangeFF(BlockContainer container, GraphicsContext g2,
			RectangleConstraint constraint) {
		double[] w = new double[5];
		double[] h = new double[5];
		...
		if (this.topBlock != null) {
			this.topBlock.setBounds(new Rectangle2D(0.0, 0.0, w[0],
					h[0]));
		}
		if (this.bottomBlock != null) {
			this.bottomBlock.setBounds(new Rectangle2D(0.0, h[0] + h[2],
					w[1], h[1]));
		}
		if (this.leftBlock != null) {
			this.leftBlock.setBounds(new Rectangle2D(0.0, h[0], w[2],
		...
		if (this.rightBlock != null) {
			this.rightBlock.setBounds(new Rectangle2D(w[2] + w[4], h[0],
					w[3], h[3]));
		}
		if (this.centerBlock != null) {
			this.centerBlock.setBounds(new Rectangle2D(w[2], h[0], w[4],
					h[4]));
		}
