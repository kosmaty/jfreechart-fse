...
public class PaintUtils {
	 ...
	 * {@code LinearGradientPaint} and {@code RadialGradientPaint} as a special
	 * cases, since those classes do not override the {@code equals()} method.
	 *
	 * @param p1
	...
	/**
	 * Returns {@code true} if the maps contain the same keys and {@link Paint}
	 * values, and {@code false} otherwise.
	 *
	 * @param m1
	 *            map 1 ({@code null} not permitted).
	 * @param m2
	 *            map 2 ({@code null} not permitted).
	 *
	 * @return A boolean.
	 */
