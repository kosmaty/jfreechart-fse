...
public class ParamChecks {
	 ...
	 *            the value.
	 * @param name
	 *            the parameter name (to use in the exception message).
	 */
	 ...
	 *
	 * @throws IllegalArgumentException
	 *             if the supplied <code>value</code> is not in the range
	 *             <code>lowerBound</code> to <code>upperBound</code> inclusive.
	 *
	 * @since 1.0.15
	 */
