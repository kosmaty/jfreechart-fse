...
public abstract class Marker implements Cloneable, Serializable {
	 ...
	 * @param outlinePaint
	 *            the outline paint ({@code null} permitted).
	 * @param outlineStroke
	 *            the outline stroke ({@code null} permitted).
	 * @param alpha
	 ...
	 *
	 * @throws IllegalArgumentException
	 *             if {@code alpha} is not in the specified range.
	 *
	 * @see #getAlpha()
	 */
	 ...
	 *
	 * @param offset
	 *            the label offset ({@code null} not permitted).
	 *
	 * @see #getLabelOffset()
	 */
	 ...
	 *
	 * @param adj
	 *            the type ({@code null} not permitted).
	 *
	 ...
	 *
	 * @param anchor
	 *            the label text anchor ({@code null} not permitted).
	 *
