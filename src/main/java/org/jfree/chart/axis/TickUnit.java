...
public abstract class TickUnit implements Comparable<TickUnit>, Serializable {
	...
	/**
	 * The number of minor tick intervals between major tick marks. Note that
	 * the number of minor tick marks will be one less than this number (for
	 * example, if the number of intervals is 10, the number of minor tick marks
	 * will be 9).
	 *
	 * @since 1.0.7
	 */
	...
	/**
	 * Returns the number of minor tick intervals between major tick marks. If
	 * this is <code>1</code> or less, no minor tick marks will be displayed.
	 * 
