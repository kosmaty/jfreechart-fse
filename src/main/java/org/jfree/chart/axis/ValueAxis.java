...
public abstract class ValueAxis extends Axis
	...
	// * <P>
	// * For a regular axis, values increase from left to right (for a
	// horizontal
	...
	// * axis range is set explicitly). The default value is 0.05 (five
	// percent).
	// *
	...
	// * margin is added only when the axis range is auto-calculated - if you
	// set
	// * the axis range manually, the margin is ignored.
	// *
	// * @param margin the margin percentage (for example, 0.05 is five
	// percent).
	// *
	// * @see #getLowerMargin()
	...
	// * range) and sends an {@link AxisChangeEvent} to all registered
	// listeners.
	...
	//
	// /**
	// * Sets the source for obtaining standard tick units for the axis and
	// sends
	// * an {@link AxisChangeEvent} to all registered listeners. The axis will
	// * try to select the smallest tick unit from the source that does not
	// cause
	...
	// */
	// public abstract double java2DToValue(double java2DValue, Rectangle2D
	// area,
	// RectangleEdge edge);
	//
	// /**
	...
	// * the central value and sends an {@link AxisChangeEvent} to all
	// registered
	// * listeners.
	// * <P>
