...
public abstract class Axis implements Cloneable, Serializable {
	...
	//
	// /**
	// * Sets the insets for the axis label, and sends an {@link
	// AxisChangeEvent}
	// * to all registered listeners.
	// *
	...
	//
	// /**
	// * Sets the angle for the label and sends an {@link AxisChangeEvent} to
	// all
	// * registered listeners.
	// *
	...
	// * used for layout purposes (it gives the maximum dimensions of the
	// label).
	// *
	// * @param g2 the graphics device.
	// * @param edge the edge of the plot area along which the axis is
	// measuring.
	// *
	// * @return The enclosing rectangle.
	// */
	// protected Rectangle2D getLabelEnclosure(Graphics2D g2, RectangleEdge
	// edge) {
