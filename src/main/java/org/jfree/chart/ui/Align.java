...
public final class Align {
	 ...
	 *            the alignment code.
	 */
	public static Rectangle2D align2(final Rectangle2D rect, final Rectangle2D frame, final int align) {
		// JAVA-FX: changed method name to align2, because rect is immutable

		double x = getCenterX(frame) - rect.getWidth() / 2.0;
		double y = getCenterY(frame) - rect.getHeight() / 2.0;
