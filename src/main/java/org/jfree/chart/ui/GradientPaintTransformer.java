...
public interface GradientPaintTransformer {
	 ...
	 * shape. Classes that implement this method typically return a new instance
	 * of <code>GradientPaint</code>.
	 * 
	 * @param paint
	 ...
	 */
	public LinearGradient transform(LinearGradient paint, Shape target);
	 ...
	 * @return A transformed paint.
	 */
	public LinearGradient transform(LinearGradient paint, Rectangle2D target);
