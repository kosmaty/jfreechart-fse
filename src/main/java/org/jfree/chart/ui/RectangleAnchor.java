...
public enum RectangleAnchor {
	...
	public Point2D getAnchorPoint(Rectangle2D rectangle) {
		...
		if (this == RectangleAnchor.CENTER) {
			result = new Point2D(getCenterX(rectangle), getCenterY(rectangle));
		} else if (this == RectangleAnchor.TOP) {
			result = new Point2D(getCenterX(rectangle), rectangle.getMinY());
		} else if (this == RectangleAnchor.BOTTOM) {
			result = new Point2D(getCenterX(rectangle), rectangle.getMaxY());
		} else if (this == RectangleAnchor.LEFT) {
			result = new Point2D(rectangle.getMinX(), getCenterY(rectangle));
		} else if (this == RectangleAnchor.RIGHT) {
			result = new Point2D(rectangle.getMaxX(), getCenterY(rectangle));
		} else if (this == RectangleAnchor.TOP_LEFT) {
			result = new Point2D(rectangle.getMinX(), rectangle.getMinY());
		} else if (this == RectangleAnchor.TOP_RIGHT) {
			result = new Point2D(rectangle.getMaxX(), rectangle.getMinY());
		} else if (this == RectangleAnchor.BOTTOM_LEFT) {
			result = new Point2D(rectangle.getMinX(), rectangle.getMaxY());
		} else if (this == RectangleAnchor.BOTTOM_RIGHT) {
			result = new Point2D(rectangle.getMaxX(), rectangle.getMaxY());
		} else {
	 ...
	 *
	 * @param dimensions
	 *            the dimensions ({@code null} not permitted).
	 * @param anchorX
	 *            the x-anchor.
	 * @param anchorY
	 *            the y-anchor.
	...
	public static Rectangle2D createRectangle(Size2D dimensions,
		...
		if (anchor == RectangleAnchor.CENTER) {
			result = new Rectangle2D(anchorX - w / 2.0,
					anchorY - h / 2.0, w, h);
		} else if (anchor == RectangleAnchor.TOP) {
			result = new Rectangle2D(anchorX - w / 2.0, anchorY, w, h);
		} else if (anchor == RectangleAnchor.BOTTOM) {
			result = new Rectangle2D(anchorX - w / 2.0, anchorY - h,
					w, h);
		} else if (anchor == RectangleAnchor.LEFT) {
			result = new Rectangle2D(anchorX, anchorY - h / 2.0, w, h);
		} else if (anchor == RectangleAnchor.RIGHT) {
			result = new Rectangle2D(anchorX - w, anchorY - h / 2.0,
					w, h);
		} else if (anchor == RectangleAnchor.TOP_LEFT) {
			result = new Rectangle2D(anchorX, anchorY, w, h);
		} else if (anchor == RectangleAnchor.TOP_RIGHT) {
			result = new Rectangle2D(anchorX - w, anchorY, w, h);
		} else if (anchor == RectangleAnchor.BOTTOM_LEFT) {
			result = new Rectangle2D(anchorX, anchorY - h, w, h);
		} else if (anchor == RectangleAnchor.BOTTOM_RIGHT) {
			result = new Rectangle2D(anchorX - w, anchorY - h, w, h);
		}
		return result;
	}
