...
public class LegendItem implements Cloneable, Serializable {
	...
	public LegendItem(String label, Paint paint) {
		this(label, null, null, null, asShape(new Rectangle2D(-4.0, -4.0, 8.0, 8.0)), paint);
	 ...
	 * @param fillPaint
	 *            the paint used to fill the shape ({@code null} not permitted).
	 */
	 ...
	 *            the paint used to fill the shape ({@code null} not permitted).
	 * @param outlineStroke
	 *            the outline stroke ({@code null} not permitted).
	 * @param outlinePaint
	 *            the outline paint ({@code null} not permitted).
	 */
	...
	public int hashCode() {
		int hash = 7;
		hash = 47 * hash + (this.seriesKey != null ? this.seriesKey.hashCode() :
				0);
	 ...
	 * still reference the same dataset as the original <code>LegendItem</code>
	 * ).
	 *
	 * @return A clone.
	 *
