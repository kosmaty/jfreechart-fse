...
public interface WindDataset extends XYDataset {
	...
	/**
	 * Returns the wind direction (should be in the range 0 to 12, corresponding
	 * to the positions on an upside-down clock face).
	 *
	 * @param series
	 *            the series (in the range <code>0</code> to
	 *            <code>getSeriesCount() - 1</code>).
	 * @param item
	 *            the item (in the range <code>0</code> to
