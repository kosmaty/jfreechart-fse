...
/**
 * A simple implementation of the {@link OHLCDataset} interface. See also the
 * {@link DefaultOHLCDataset} class, which provides another implementation that
 * is very similar.
 */
public class DefaultHighLowDataset extends AbstractXYDataset
	 ...
	 *
	 * @param seriesKey
	 *            the key for the series (<code>null</code> not permitted).
	 * @param date
	 *            the dates (<code>null</code> not permitted).
	 * @param high
	 *            the high values (<code>null</code> not permitted).
	 * @param low
	 *            the low values (<code>null</code> not permitted).
	 * @param open
	 *            the open values (<code>null</code> not permitted).
	 * @param close
	 *            the close values (<code>null</code> not permitted).
	 * @param volume
	 *            the volume values (<code>null</code> not permitted).
	 */
	 ...
	 *
	 * @param series
	 *            the index of the series (ignored, this dataset supports only
	 *            one series and this method always returns the key for series
	 *            0).
	 *
	 ...
	 * <code>Date</code> object. To avoid generating a new object instance, you
	 * might prefer to call {@link #getXValue(int, int)}.
	 *
	 * @param series
	 ...
	 *
	 * @param data
	 *            the double values to convert (<code>null</code> not
	 *            permitted).
	 *
