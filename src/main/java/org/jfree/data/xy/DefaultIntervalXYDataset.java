 ...
 * y-values. This implementation uses six arrays to store the x, start-x, end-x,
 * y, start-y and end-y values. <br>
 * <br>
 * An alternative implementation of the {@link IntervalXYDataset} interface is
 * provided by the {@link XYIntervalSeriesCollection} class.
 *
 * @since 1.0.3
 */
public class DefaultIntervalXYDataset extends AbstractIntervalXYDataset
	 ...
	 * @param data
	 *            the data (must be an array with length 6, containing six
	 *            arrays of equal length, the first three containing the
	 *            x-values (x, xLow and xHigh) and the last three containing the
	 *            y-values (y, yLow and yHigh)).
	 */
	 ...
	 * <li>both datasets have the same number of series, each containing exactly
	 * the same values.</li>
	 * </ul>
	 *
	 * @param obj
	 ...
	 *             if the dataset contains a series with a key that cannot be
	 *             cloned.
	 */
	@Override
