...
public class DefaultTableXYDataset extends AbstractIntervalXYDataset
	 ...
	 *
	 * @param autoPrune
	 *            a flag that controls whether or not x-values are removed
	 *            whenever the corresponding y-values are all <code>null</code>.
	 */
	 ...
	 * all registered listeners. The series should be configured to NOT allow
	 * duplicate x-values.
	 *
	 * @param series
	 ...
	 * If the factor is 0.5, the gap is in the middle of the x values. If it is
	 * lesser than 0.5, the gap is farther to the left and if greater than 0.5
	 * it gets farther to the right.
	 *
	 * @param d
