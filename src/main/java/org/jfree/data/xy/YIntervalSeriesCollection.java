...
public class YIntervalSeriesCollection extends AbstractIntervalXYDataset
	...
	/**
	 * Returns the start x-value for an item within a series. This method maps
	 * directly to {@link #getX(int, int)}.
	 *
	 * @param series
	 *            the series index.
	 * @param item
	...
	/**
	 * Returns the end x-value for an item within a series. This method maps
	 * directly to {@link #getX(int, int)}.
	 *
	 * @param series
	 *            the series index.
