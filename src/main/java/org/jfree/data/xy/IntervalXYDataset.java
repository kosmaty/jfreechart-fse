...
/**
 * An extension of the {@link XYDataset} interface that allows an x-interval and
 * a y-interval to be defined. Note that the x and y values defined by the
 * parent interface are NOT required to fall within these intervals. This
 * interface is used to support (among other things) bar plots against numerical
 * axes.
 */
public interface IntervalXYDataset extends XYDataset {
	 ...
	 * item. If this lower bound is specified, it should be less than or equal
	 * to the upper bound of the interval (if one is specified).
	 *
	 * @param series
	...
	/**
	 * Returns the lower bound of the x-interval (as a double primitive) for the
	...
	/**
	 * Returns the upper bound of the x-interval (as a double primitive) for the
	 * specified series and item.
	 *
	 * @param series
	 *            the series index (zero-based).
	...
	/**
	 * Returns the lower bound of the y-interval (as a double primitive) for the
	 * specified series and item.
	 *
	 * @param series
	 *            the series index (zero-based).
	...
	/**
	 * Returns the upper bound of the y-interval (as a double primitive) for the
	 * specified series and item.
	 *
	 * @param series
	 *            the series index (zero-based).
