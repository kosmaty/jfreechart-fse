...
/**
 * A default implementation of the {@link XYZDataset} interface that stores data
...
public class DefaultXYZDataset extends AbstractXYZDataset
	 ...
	 *             if <code>series</code> or <code>item</code> is not within the
	 *             specified range.
	 *
	 * @see #getX(int, int)
	 */
	 ...
	 *             if there is a problem cloning the dataset (for instance, if a
	 *             non-cloneable object is used for a series key).
	 */
	@Override
