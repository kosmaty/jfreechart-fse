...
public class DefaultWindDataset extends AbstractXYDataset
	...
	/**
	 * Constructs a new, empty, dataset. Since there are currently no methods to
	 * add data to an existing dataset, you should probably use a different
	 * constructor.
	 */
	 ...
	 *
	 * @param data
	 *            the data ({@code null} not permitted).
	 *
	 ...
	 *
	 * @param seriesNames
	 *            the names of the series ({@code null} not permitted).
	 * @param data
	 *            the wind data.
	 *
	 * @throws NullPointerException
	 *             if {@code seriesNames} is {@code null}.
	 */
	...
	/**
	 * Constructs a dataset based on the specified data array. The array can
	 * contain multiple series, each series can contain multiple items, and each
	 * item is as follows:
	 * <ul>
	 * <li>{@code data[series][item][0]} - the date (either a {@code Date} or a
	 * {@code Number} that is the milliseconds since 1-Jan-1970);</li>
	 * <li>{@code data[series][item][1]} - the wind direction (1 - 12, like the
	 ...
	 *            the names of the series ({@code null} not permitted).
	 * @param data
	 *            the wind dataset ({@code null} not permitted).
	 *
	 * @throws IllegalArgumentException
	 *             if {@code seriesKeys} is {@code null} or the number of series
	 *             keys does not match the number of series in the array.
	 * @throws NullPointerException
	 *             if {@code data} is {@code null}.
	 */
	 ...
	 * between 0 and 12, like the numbers on an upside-down clock face.
	 *
	 * @param series
	 *            the series (zero-based index).
	 * @param item
	 ...
	 *
	 * @param data
	 *            the wind data ({@code null} not permitted).
	 *
	...
	/**
	 * Checks this {@code WindDataset} for equality with an arbitrary object.
