...
public class XYBarDataset extends AbstractIntervalXYDataset
	...
	/**
	 * Returns the starting x-value (as a double primitive) for an item within a
	 * series.
	 *
	 * @param series
	 *            the series index (zero-based).
	...
	/**
	 * Returns the ending x-value (as a double primitive) for an item within a
	 * series.
	 *
	 * @param series
	 *            the series index (zero-based).
	...
	/**
	 * Returns the starting y-value (as a double primitive) for an item within a
	 * series.
	 *
	 * @param series
	 *            the series index (zero-based).
	...
	/**
	 * Returns the ending y-value (as a double primitive) for an item within a
	 * series.
	 *
	 * @param series
	 *            the series index (zero-based).
