...
public class XIntervalSeriesCollection extends AbstractIntervalXYDataset
	...
	/**
	 * Returns the start y-value for an item within a series. This method maps
	 * directly to {@link #getY(int, int)}.
	 *
	 * @param series
	 *            the series index.
	 * @param item
	...
	/**
	 * Returns the end y-value for an item within a series. This method maps
	 * directly to {@link #getY(int, int)}.
	 *
	 * @param series
	 *            the series index.
