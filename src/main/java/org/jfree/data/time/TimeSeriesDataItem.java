...
public class TimeSeriesDataItem implements Cloneable, Comparable<TimeSeriesDataItem>, Serializable {
	...
	/**
	 * Returns an integer indicating the order of this data pair object relative
	 * to another object.
	 * <P>
	 * For the order we consider only the timing: negative == before, zero ==
	 * same, positive == after.
	 *
	 * @param o1
	 *            The object being compared to.
	 *
	 * @return An integer indicating the order of the data item object relative
	 *         to another object.
	 */
	@Override
