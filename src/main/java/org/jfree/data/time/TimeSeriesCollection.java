...
public class TimeSeriesCollection extends AbstractIntervalXYDataset
	 ...
	 *
	 * @param zone
	 *            the timezone ({@code null} permitted, will use
	...
	/**
	 * Constructs a dataset containing a single series (more can be added), tied
	 * to the default timezone.
	 *
	 * @param series
	 *            the series ({@code null} permitted).
	 */
	 ...
	 *
	 * @param series
	 *            a series to add to the collection ({@code null} permitted).
	 * @param zone
	 *            the timezone ({@code null} permitted, will use
	 *            {@code TimeZone.getDefault()} in that case).
	 */
	 ...
	 * The default value is {@code TimePeriodAnchor.START}.
	 *
	 ...
	 *
	 * @param series
	 *            the series ({@code null} not permitted).
	 *
	...
	/**
	 * Returns the series with the specified key, or {@code null} if there is no
	 * such series.
	 *
	 * @param key
	 *            the series key ({@code null} permitted).
	 *
	 ...
	 *            a list of keys for the visible series.
	 * @param includeInterval
	 ...
	 * collection has changed, and vetos it if the key is already present in the
	 * collection.
	 * 
	 * @param e
	 *            the event.
