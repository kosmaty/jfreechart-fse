...
/**
 * Represents a year in the range -9999 to 9999. This class is immutable, which
...
public class Year extends RegularTimePeriod implements Serializable {
	...
	/**
	 * Creates a new <code>Year</code> instance, for the specified time zone and
	 * locale.
	 *
	 * @param time
	 *            the current time (<code>null</code> not permitted).
	 * @param zone
	 *            the time zone.
	 * @param locale
	 *            the locale.
	...
	/**
	 * Returns the last millisecond of the year. This will be determined
	 * relative to the time zone specified in the constructor, or in the
	 * calendar instance passed in the most recent call to the
	 * {@link #peg(Calendar)} method.
	 *
	 ...
	 *
	 * @return The year preceding this one (or <code>null</code> if the current
	 *         year is -9999).
	 */
	@Override
