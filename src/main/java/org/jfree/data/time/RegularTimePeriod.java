...
public abstract class RegularTimePeriod implements TimePeriod,
	...
	/**
	 * Returns the time period preceding this one, or {@code null} if some lower
	...
	/**
	 * Returns the time period following this one, or {@code null} if some limit
	 * has been reached.
	 *
	 ...
	 * returns a new {@code Date} instance every time it is called.
	 *
	 ...
	 * specified {@code anchor} using the supplied {@code calendar} (which
