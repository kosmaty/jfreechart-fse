 ...
 * period (for example, {@link Day}) and (b) that each period appears at most
...
public class TimeSeries extends Series implements Cloneable, Serializable {
	 ...
	 *
	 * @param name
	 *            the series name ({@code null} not permitted).
	 */
	 ...
	 *
	 * @param name
	 *            the name of the series ({@code null} not permitted).
	 * @param domain
	 *            the domain description ({@code null} permitted).
	 * @param range
	 *            the range description ({@code null} permitted).
	 *
	 * @since 1.0.13
	 */
	...
	/**
	 * Sets the domain description and sends a {@code PropertyChangeEvent} (with
	 * the property name {@code Domain}) to all registered property change
	 * listeners.
	 *
	 * @param description
	...
	/**
	 * Sets the range description and sends a {@code PropertyChangeEvent} (with
	 * the property name {@code Range}) to all registered listeners.
	 *
	 * @param description
	 *            the description ({@code null} permitted).
	 *
	...
	/**
	 * Returns the range of y-values in the time series that fall within the
	 * specified range of x-values. This is equivalent to
	 * {@code findValueRange(xRange, TimePeriodAnchor.MIDDLE, timeZone)}.
	 * 
	 * @param xRange
	 *            the subrange of x-values ({@code null} not permitted).
	 * @param timeZone
	 ...
	 * 
	 * @param xRange
	 *            the subset of x-values to use ({@code null} not permitted).
	 * @param xAnchor
	 *            the anchor point for the x-values ({@code null} not
	 *            permitted).
	 * @param zone
	...
	/**
	 * Returns the smallest y-value in the series, ignoring any {@code null} and
	 * {@code Double.NaN} values. This method returns {@code Double.NaN} if
	...
	/**
	 * Returns the largest y-value in the series, ignoring any {@code null} and
	 * {@code Double.NaN} values. This method returns {@code Double.NaN} if
	 * there is no largest y-value (for example, when the series is empty).
	 *
	 ...
	 *
	 * @return The time period class (may be {@code null} but only for an empty
	 *         series).
	 */
	 ...
	 * object is a clone of the item in the series, so modifying it will have no
	 * effect on the data series.
	 *
	 * @param period
	 *            the period of interest ({@code null} not allowed).
	 *
	 * @return The data item matching the specified period (or {@code null} if
	 *         there is no match).
	 *
	 * @see #getDataItem(int)
	 */
	...
	/**
	 * Returns a data item for the series. This method returns the object that
	 * is used for the underlying storage - you should not modify the contents
	 * of the returned value unless you know what you are doing.
	 *
	 * @param index
	 ...
	 *
	 * @param period
	 *            the time period ({@code null} not permitted).
	 *
	 * @return The index.
	 */
	 ...
	 *
	 * @param period
	 *            time period ({@code null} not permitted).
	 *
	 * @return The value (possibly {@code null}).
	 */
	 ...
	 *
	 * @param item
	 *            the (timeperiod, value) pair ({@code null} not permitted).
	 */
	 ...
	 *
	 * @param period
	 *            the period ({@code null} not permitted).
	 * @param value
	 *            the value.
	 *
	 * @since 1.0.14
	 ...
	 *            the index of the data item.
	 * @param value
	 *            the new value ({@code null} permitted).
	 */
	 ...
	 *
	 * @param period
	 *            the time period to add/update ({@code null} not permitted).
	 * @param value
	 *            the new value.
	 *
	 * @return A copy of the overwritten data item, or {@code null} if no item
	 *         was overwritten.
	 */
	 ...
	 *
	 * @param item
	 *            the data item ({@code null} not permitted).
	 *
	 * @return A copy of the overwritten data item, or {@code null} if no item
	 *         was overwritten.
	 *
	 ...
	 *
	 * @param period
	 *            the period of the item to delete ({@code null} not permitted).
	 */
	 ...
	 *
	 * @param start
	 *            the first time period to copy ({@code null} not permitted).
	 * @param end
	 *            the last time period to copy ({@code null} not permitted).
	 *
	 ...
	 *
	 * @param obj
	 *            the object to test against ({@code null} permitted).
	 *
	 * @return A boolean.
	 */
	@Override
	 ...
	 *
	 * @param item
	 *            the item added ({@code null} not permitted).
	 *
	 * @since 1.0.14
	 */
