...
public class Second extends RegularTimePeriod implements Serializable {
	...
	/**
	 * The first millisecond. We don't store the last millisecond, because it is
	 * always firstMillisecond + 999L.
	 */
	...
	/**
	 * Returns the last millisecond of the second. This will be determined
	 * relative to the time zone specified in the constructor, or in the
	 * calendar instance passed in the most recent call to the
	 * {@link #peg(Calendar)} method.
	 *
	...
	/**
	 * Creates a new instance by parsing a string. The string is assumed to be
	 * in the format "YYYY-MM-DD HH:MM:SS", perhaps with leading or trailing
	 * whitespace.
	 *
	 * @param s
	 *            the string to parse.
