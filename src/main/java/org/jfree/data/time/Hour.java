...
public class Hour extends RegularTimePeriod implements Serializable {
	...
	/**
	 * Constructs a new instance, based on the supplied date/time and the
	 * default time zone.
	 *
	 * @param time
	...
	/**
	 * Constructs a new instance, based on the supplied date/time evaluated in
	...
	/**
	 * Returns the last millisecond of the hour. This will be determined
	 * relative to the time zone specified in the constructor, or in the
	 * calendar instance passed in the most recent call to the
	 * {@link #peg(Calendar)} method.
	 *
	 ...
	 *
	 * @return {@code true} if the hour and day value of the object is the same
	 *         as this.
	 */
	@Override
	...
	/**
	 * Creates an Hour instance by parsing a string. The string is assumed to be
	 * in the format "YYYY-MM-DD HH", perhaps with leading or trailing
	 * whitespace.
	 *
	 * @param s
