...
public class Month extends RegularTimePeriod implements Serializable {
	...
	/**
	 * Returns the last millisecond of the month. This will be determined
	 * relative to the time zone specified in the constructor, or in the
	 * calendar instance passed in the most recent call to the
	 * {@link #peg(Calendar)} method.
	 *
	...
	/**
	 * Tests the equality of this Month object to an arbitrary object. Returns
	 * true if the target is a Month instance representing the same month as
	 ...
	 * the specified object: negative == before, zero == same, positive ==
	 * after.
	 *
	 * @param o1
	...
	/**
	 * Parses the string argument as a month. This method is required to accept
	 * the format "YYYY-MM". It will also accept "MM-YYYY". Anything else, at
	...
	/**
	 * Finds the first occurrence of '-', or if that character is not found, the
	 * first occurrence of ',', or the first occurrence of ' ' or '.'
	 *
	 * @param s
	 *            the string to parse.
	 *
