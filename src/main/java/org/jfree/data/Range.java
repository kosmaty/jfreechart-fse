...
public strictfp class Range implements Serializable {
	...
	/**
	 * Returns {@code true} if the range intersects with the specified range,
	 ...
	 *
	 * @param range
	 *            another range ({@code null} not permitted).
	 *
	 * @return A boolean.
	 *
	 * @since 1.0.9
	 ...
	 *
	 * @param range1
	 *            the first range ({@code null} permitted).
	 * @param range2
	 *            the second range ({@code null} permitted).
	 *
	...
	/**
	 * Returns a new range that spans both {@code range1} and {@code range2}.
	 ...
	 *
	 * @param base
	 *            the base range ({@code null} not permitted).
	 * @param delta
	 *            the shift amount.
	 *
	 * @return A new range.
	...
	/**
	 * Returns the given {@code value} adjusted by {@code delta} but with a
	 * check to prevent the result from crossing {@code 0.0}.
	 *
	 * @param value
	 *            the value.
	 * @param delta
