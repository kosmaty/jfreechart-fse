...
/**
 * A data series containing a sequence of <code>(x, y, z)</code> data items. The
 * series has a key to identify it, and can be added to an
 * {@link XYZSeriesCollection} to create a dataset. <br>
 * <br>
