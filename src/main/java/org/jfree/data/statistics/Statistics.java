...
public abstract class Statistics {
	 ...
	 *
	 * @param values
	 *            the values ({@code null} not permitted).
	 *
	 * @return The mean.
	 */
	 ...
	 *            a flag that controls whether or not {@code null} and
	 *            {@code Double.NaN} values are included in the calculation (if
	 *            either is present in the array, the result is
	 *            {@link Double#NaN}).
	 *
	 * @return The mean.
	 *
	...
	/**
	 * Calculates the median for a list of values ({@code Number} objects). The
	 * list of values will be copied, and the copy sorted, before calculating
	 * the median. To avoid this step (if your list of values is already
	 * sorted), use the {@link #calculateMedian(List, boolean)} method.
	 *
	 * @param values
	...
	/**
	 * Calculates the median for a list of values ({@code Number} objects). If
	 * {@code copyAndSort} is {@code false}, the list is assumed to be presorted
	 ...
	 *
	 * @param values
	 *            the values, in any order ({@code null} not permitted).
	 * @param start
	 *            the start index.
	 * @param end
	 *            the end index.
	 ...
	 *            the end index.
	 * @param copyAndSort
	 *            a flag that that controls whether the list of values is copied
	 *            and sorted.
	 *
	 * @return The median.
	 */
	 ...
	 *
	 * @param data
	 *            the data ({@code null} or zero length array not permitted).
	 *
	 ...
	 *
	 * @param xData
	 *            the x-data ({@code null} not permitted).
	 * @param yData
	 *            the y-data ({@code null} not permitted).
	 *
	 ...
	 *
	 * @param xData
	 *            the x-values ({@code null} not permitted).
	 * @param yData
	 *            the y-values ({@code null} not permitted).
	 *
	 * @return The slope.
	 */
