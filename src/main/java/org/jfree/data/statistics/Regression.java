...
public abstract class Regression {
	 ...
	 * the data using a power regression equation. The result is returned as an
	 * array, where double[0] --&gt; a, and double[1] --&gt; b.
	 *
	 * @param data
	 *            the data.
	 *
	 ...
	 * function of order n, y = a0 + a1 * x + a2 * x^2 + ... + an * x^n, fitted
	 * to the data using a polynomial regression equation. The result is
	 * returned as an array with a length of n + 2, where double[0] --&gt; a0,
	 * double[1] --&gt; a1, .., double[n] --&gt; an. and double[n + 1] is the
	 * correlation coefficient R2 Reference: J. D. Faires, R. L. Burden,
	 * Numerische Methoden (german edition), pp. 243ff and 327ff.
	 *
	 * @param dataset
	 *            the dataset (<code>null</code> not permitted).
	 * @param series
	 *            the series to fit the regression line against (the series must
	 *            have at least order + 1 non-NaN items).
	 * @param order
	 *            the order of the function (&gt; 0).
	 *
	 * @return The parameters.
	 *
	 * @since 1.0.14
	...
	/**
	 * Returns a matrix with the following features: (1) the number of rows and
	 * columns is 1 less than that of the original matrix; (2)the matrix is
	 * triangular, i.e. all elements a (row, column) with column &gt; row are
