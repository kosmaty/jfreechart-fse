...
public class HistogramDataset extends AbstractIntervalXYDataset
	...
	/**
	 * A flag that controls whether or not the bin count is divided by the bin
	 * size.
	 */
	...
	/**
	 * Returns the number of items in a series. Since this dataset only stores a
	 * single series, the {@code series} argument is ignored.
	 *
	 * @param series
	 ...
	 *
	 * @param bin
	 *            the bin ({@code null} not permitted).
	 *
	 * @see #removeAllBins()
	 */
	 ...
	 * the appropriate bin). A runtime exception is thrown if the value does not
	 * fit into any bin.
	 *
	 * @param value
	 *            the value.
	...
	/**
	 * Removes all bins and sends a {@link DatasetChangeEvent} to all registered
	 * listeners.
	 *
	 * @since 1.0.6
	 *
