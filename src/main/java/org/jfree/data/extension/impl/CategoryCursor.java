 ...
 * @author zinsmaie
 */
public class CategoryCursor<ROW_KEY extends Comparable<ROW_KEY>, COLUMN_KEY extends Comparable<COLUMN_KEY>> implements
		DatasetCursor {
	...
	/**
	 * creates a cursor without assigned position (the cursor will only be valid
	 * if setPosition is called at some time)
	 */
	 ...
	 * @param columnKey
	 *            the column key ({@code null} not permitted).
	 */
