...
public class XYDatasetSelectionExtension extends
	...
	/**
	 * Storage for the selection attributes of the data items (one list for each
	 * series).
	 */
	...
	// can't instantiate selection data with
	 ...
	 * 
	 * @param cursor
	 *            specifies the position of the data item ({@code null} not
	 *            permitted).
	 * 
	 * @return A boolean.
	 */
	...
	private class XYDatasetSelectionIterator
		 ...
		 * 
		 * @param selected
		 *            if true the iterator will iterate over the selected data
		 *            item positions
		 */
		...
		/**
		 * Calculates the next position based on the current position and the
		 * filter status.
		 * 
