 ...
 */
public abstract class AbstractDatasetSelectionExtension<CURSOR extends DatasetCursor, DATASET extends Dataset>
		implements
	 ...
	 * 
	 * @param dataset
	 *            the underlying dataset ({@code null} not permitted).
	 */
	...
	/**
	 * {@link DatasetSelectionExtension#addChangeListener(java.util.EventListener)}
	 */
	@Override
	...
	// add method accepts only SelectionChangeListeners<CURSOR>
