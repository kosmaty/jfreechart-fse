...
public class DefaultHeatMapDataset extends AbstractDataset
	...
	/**
	 * Creates a new dataset where all the z-values are initially 0. This is a
	 * fixed size array of z-values.
	 *
	 * @param xSamples
	...
	/**
	 * Returns the z-value at the specified sample position in the dataset. In
	 * this implementation, where the underlying values are stored in an array
	 * of double primitives, you should avoid using this method and use
	 * {@link #getZValue(int, int)} instead.
	 *
	 * @param xIndex
	 *            the position of the x sample in the dataset.
	 * @param yIndex
