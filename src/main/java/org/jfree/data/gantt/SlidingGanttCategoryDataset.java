 ...
 * category can be modified, which provides a means of "sliding" through the
 * categories in the underlying dataset.
 *
 * @since 1.0.10
 */
public class SlidingGanttCategoryDataset extends AbstractDataset
	 ...
	 * @param firstColumn
	 *            the index of the first visible column from the underlying
	 *            dataset.
	 * @param maxColumns
	...
	/**
	 * Sets the maximum category count and sends a {@link DatasetChangeEvent} to
