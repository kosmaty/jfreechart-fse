...
public class DefaultIntervalCategoryDataset extends AbstractSeriesDataset
	 ...
	 *
	 * @param starts
	 *            the starting values for the intervals (<code>null</code> not
	 *            permitted).
	 * @param ends
	 *            the ending values for the intervals (<code>null</code> not
	 *            permitted).
	 */
	...
	/**
	 * Constructs a DefaultIntervalCategoryDataset, populates it with data from
	 * the arrays, and uses the supplied names for the series.
	 * <p>
	 * Category names are generated automatically ("Category 1", "Category 2",
	 * etc).
	 *
	 * @param seriesNames
	 *            the series names (if <code>null</code>, series names will be
	...
	/**
	 * Constructs a DefaultIntervalCategoryDataset, populates it with data from
	 * the arrays, and uses the supplied names for the series and the supplied
	 * objects for the categories.
	 *
	 * @param seriesKeys
	 *            the series keys (if <code>null</code>, series keys will be
	 *            generated automatically).
	 * @param categoryKeys
	 *            the category keys (if <code>null</code>, category keys will be
	 *            generated automatically).
	 * @param starts
	 *            the start values data, indexed as data[series][category].
	 * @param ends
	 ...
	 *
	 * @param seriesKeys
	 *            the new keys (<code>null</code> not permitted, the length of
	 *            the array must match the number of series in the dataset).
	 *
	...
	/**
	 * Returns a list of the categories in the dataset. This method supports the
	 ...
	 *
	 * @param categoryKeys
	 *            an array of objects representing the categories in the
	 *            dataset.
	 *
	 * @see #getRowKeys()
	 ...
	 *
	 * @param array
	 *            the array (<code>null</code> not permitted).
	 *
