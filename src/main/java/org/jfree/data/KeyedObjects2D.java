...
public class KeyedObjects2D implements Cloneable, Serializable {
	 ...
	 *
	 * @param row
	 *            the row index (in the range 0 to getRowCount() - 1).
	 * @param column
	 ...
	 *             if <code>rowKey</code> or <code>columnKey</code> is
	 *             <code>null</code>.
	 * @throws UnknownKeyException
	 *             if <code>rowKey</code> or <code>columnKey</code> is not
	 *             recognised.
	 */
	 ...
	 *
	 * @throws UnknownKeyException
	 *             if <code>rowKey</code> is not recognised.
	 *
