...
public class CategoryPlotTest {
	...
	public void testEquals() {
		...
		plot1.setDomainGridlinePaint(
				new LinearGradient(
						1.0, 2.0, 3.0, 4.0, true, CycleMethod.NO_CYCLE,
		...
		// assertFalse(plot1.equals(plot2));
		// plot2.setRangeGridlinePaint(new GradientPaint(1.0f, 2.0f,
		// Color.green,
		// 3.0f, 4.0f, Color.yellow));
		// assertEquals(plot1, plot2);
		...
		// 3.0f, 4.0f, Color.yellow));
		// assertFalse(plot1.equals(plot2));
		// plot2.setRangeCrosshairPaint(new GradientPaint(1.0f, 2.0f,
		// Color.WHITE,
		// 3.0f, 4.0f, Color.yellow));
		// assertEquals(plot1, plot2);
		...
		// plot1.setDomainCrosshairPaint(new GradientPaint(1.0f, 2.0f,
		// Color.RED,
		// 3.0f, 4.0f, Color.BLUE));
		// assertFalse(plot1.equals(plot2));
		// plot2.setDomainCrosshairPaint(new GradientPaint(1.0f, 2.0f,
		// Color.RED,
		// 3.0f, 4.0f, Color.BLUE));
		// assertEquals(plot1, plot2);
		...
		// assertFalse(plot1.equals(plot2));
		// plot2.setRangeMinorGridlinePaint(new GradientPaint(1.0f, 2.0f,
		// Color.RED,
		// 3.0f, 4.0f, Color.BLUE));
		// assertEquals(plot1, plot2);
		...
		// Color.RED, 3.0f, 4.0f, Color.BLUE));
		// assertFalse(plot1.equals(plot2));
		// plot2.setRangeZeroBaselinePaint(new GradientPaint(1.0f, 2.0f,
		// Color.RED,
		// 3.0f, 4.0f, Color.BLUE));
		// assertEquals(plot1, plot2);
	...
	public void testCloning() throws CloneNotSupportedException {
		...
		// 3.0f, 4.0f, Color.yellow));
		// p1.setRangeMinorGridlinePaint(new GradientPaint(2.0f, 3.0f,
		// Color.WHITE,
		// 4.0f, 5.0f, Color.RED));
	...
	public void test1654215() {
		...
		chart.draw(g2, new Rectangle2D(0, 0, 200, 100), null, null);
	}
