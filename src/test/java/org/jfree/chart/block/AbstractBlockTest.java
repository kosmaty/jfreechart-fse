...
public class AbstractBlockTest {
	...
	public void testEquals() {
		...
		b1.setBounds(new Rectangle2D(1.0, 2.0, 3.0, 4.0));
		assertFalse(b1.equals(b2));
		b2.setBounds(new Rectangle2D(1.0, 2.0, 3.0, 4.0));
		assertEquals(b1, b2);
	...
	public void testCloning() throws CloneNotSupportedException {
		EmptyBlock b1 = new EmptyBlock(1.0, 2.0);
		Rectangle2D bounds1 = new Rectangle2D(1.0, 2.0, 3.0, 4.0);
		...
		b1.setBounds(new Rectangle2D(2.0, 4.0, 6.0, 8.0));
		assertFalse(b1.equals(b2));
		b2.setBounds(new Rectangle2D(2.0, 4.0, 6.0, 8.0));
		assertEquals(b1, b2);
	}
