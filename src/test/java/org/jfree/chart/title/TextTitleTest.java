...
public class TextTitleTest {
	...
	public void testEquals() {
		...
		Font f = Font.font("SansSerif", FontWeight.NORMAL, FontPosture.REGULAR, 15);
		t1.setFont(f);
		assertFalse(t1.equals(t2));
		t2.setFont(f);
		assertEquals(t1, t2);
		...
		// paint
		t1.setPaint(new LinearGradient(1.0f, 2.0f,
				3.0f, 4.0f, false, CycleMethod.NO_CYCLE, new Stop(0, Color.RED), new Stop(1, Color.BLUE)));
		assertFalse(t1.equals(t2));
		t2.setPaint(new LinearGradient(1.0f, 2.0f,
				3.0f, 4.0f, false, CycleMethod.NO_CYCLE, new Stop(0, Color.RED), new Stop(1, Color.BLUE)));
		assertEquals(t1, t2);

		// backgroundPaint
		t1.setBackgroundPaint(new LinearGradient(
				4.0f, 3.0f, 2.0f, 1.0f, false, CycleMethod.NO_CYCLE,
				new Stop(0, Color.RED), new Stop(1, Color.BLUE)));
		assertFalse(t1.equals(t2));
		t2.setBackgroundPaint(new LinearGradient(
				4.0f, 3.0f, 2.0f, 1.0f, false, CycleMethod.NO_CYCLE,
				new Stop(0, Color.RED), new Stop(1, Color.BLUE)));
		assertEquals(t1, t2);
