...
public class AxisTest {
	...
	//
	// // label font...
	// a1.setLabelFont(Font.font("Dialog", FontWeight.NORMAL,
	// FontPosture.REGULAR, 8));
	// assertNotEquals(a1, a2);
	// a2.setLabelFont(Font.font("Dialog", FontWeight.NORMAL,
	// FontPosture.REGULAR, 8));
	// assertEquals(a1, a2);
	//
	// // label paint...
	...
	// JAVAFX
	// /**
	// * Checks that serialization works, particularly with the attributed
	// label.
	// */
	// @Test
